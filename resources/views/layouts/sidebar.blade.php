...
<aside :class="{ 
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto scrollbar-thin" x-data="{ openGroup: '{{ 
        ...
        <a href="{{ route('dashboard') }}" 
           class="{{ request()->routeIs('dashboard') ? 'bg-primary-50 dark:bg-primary-900/50 text-primary-600 dark:text-primary-400 font-medium' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center gap-3 px-3 py-2 rounded-lg transition-colors mb-2">
