...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        @if(auth()->user()->hasAdminAccess())
            ...
            <a href="{{ route('reports.credit-receivables') }}" class="group block">
                <div class="glass-card-solid p-6 h-full hover:border-orange-400 dark:hover:border-orange-600 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Piutang Jatuh Tempo</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Ringkasan piutang kredit per bulan</p>
                </div>
            </a>
        @else
