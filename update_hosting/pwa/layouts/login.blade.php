                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="password" class="block w-full pl-12 pr-4 py-3 rounded-xl border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 transition-all"
