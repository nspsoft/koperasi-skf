    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="glass-card-solid p-6">
            ...
            <div class="grid grid-cols-2 gap-2">
                <a href="{{ route('import.template', 'members') }}" class="btn-secondary w-full text-center block text-xs">
                ...
                <a href="{{ route('import.template', 'members_update') }}" class="btn-secondary w-full text-center block text-xs" title="Download data anggota saat ini untuk diedit">
