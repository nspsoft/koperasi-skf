...
<div x-data="salesHistory()">
    <div class="page-header flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('pos.history.export', request()->query()) }}" class="btn-secondary flex items-center gap-1" title="Download Ringkasan Excel">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                <span class="hidden sm:inline">Excel</span>
            </a>
            <a href="{{ route('pos.history.export-items', request()->query()) }}" class="btn-secondary flex items-center gap-1" title="Download Detail Produk Terjual">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a4 4 0 014-4h4m0 0l-4-4m4 4l-4 4m5-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
