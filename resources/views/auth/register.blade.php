            ...
            <div x-show="currentStep === 3" x-transition:enter="slide-enter" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" x-model="formData.password" class="block mt-1 w-full rounded-xl shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 py-3 pl-4 pr-12"
                                   :type="showPassword ? 'text' : 'password'" name="password" required autocomplete="new-password" placeholder="Minimal 8 karakter" />
                            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 top-1 pr-4 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password_confirmation" x-model="formData.password_confirmation" class="block mt-1 w-full rounded-xl shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 py-3 pl-4 pr-12"
                                   :type="showConfirmPassword ? 'text' : 'password'" name="password_confirmation" required placeholder="Ulangi password" />
                            <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 top-1 pr-4 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none">
